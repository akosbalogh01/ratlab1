...
proc create_root_design { parentCell } {
  ...
  set OV7670_RESETN [ create_bd_port -dir O -type rst OV7670_RESETN ]
  ...
  # Create instance: capture_video_0, and set properties
  set capture_video_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:capture_video:1.0 capture_video_0 ]
  ...
  connect_bd_intf_net -intf_net capture_video_0_M_AXIS_S2MM [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins capture_video_0/M_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins capture_video_0/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports OV7670_SIOD] [get_bd_pins capture_video_0/ov7670_siod]
  connect_bd_net -net OV7670_DATA_1 [get_bd_ports OV7670_DATA] [get_bd_pins capture_video_0/ov7670_data]
  connect_bd_net -net OV7670_HREF_1 [get_bd_ports OV7670_HREF] [get_bd_pins capture_video_0/ov7670_href]
  connect_bd_net -net OV7670_PCLK_1 [get_bd_ports OV7670_PCLK] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins capture_video_0/m_axis_s2mm_aclk] [get_bd_pins capture_video_0/ov7670_pclk]
  connect_bd_net -net OV7670_VSYNC_1 [get_bd_ports OV7670_VSYNC] [get_bd_pins capture_video_0/ov7670_vsync]
  ...
  connect_bd_net -net capture_video_0_FSYNC_O [get_bd_pins axi_vdma_0/s2mm_fsync] [get_bd_pins capture_video_0/fsync]
  connect_bd_net -net capture_video_0_ov7670_pwdn [get_bd_ports OV7670_PWDN] [get_bd_pins capture_video_0/ov7670_pwdn]
  connect_bd_net -net capture_video_0_ov7670_resetn [get_bd_ports OV7670_RESETN] [get_bd_pins capture_video_0/ov7670_resetn]
  connect_bd_net -net capture_video_0_ov7670_sioc [get_bd_ports OV7670_SIOC] [get_bd_pins capture_video_0/ov7670_sioc]
  connect_bd_net -net ground_dout [get_bd_pins ground/dout] [get_bd_pins processing_system7_0/SDIO0_WP]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins BTNs_4Bits/s_axi_aclk] [get_bd_pins LEDs_4Bits/s_axi_aclk] [get_bd_pins SWs_4Bits/s_axi_aclk] [get_bd_pins axi_dispctrl_0/REF_CLK_I] [get_bd_pins axi_dispctrl_0/s_axi_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins capture_video_0/s_axi_aclk] [get_bd_pins processing_system7_0/DMA0_ACLK] [get_bd_pins processing_system7_0/DMA1_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports OV7670_XCLK] [get_bd_pins capture_video_0/clk_24] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET2_N [get_bd_pins capture_video_0/m_axis_s2mm_aresetn] [get_bd_pins processing_system7_0/FCLK_RESET2_N]
  connect_bd_net -net rst_processing_system7_0_97M_interconnect_aresetn [get_bd_pins BTNs_4Bits/s_axi_aresetn] [get_bd_pins LEDs_4Bits/s_axi_aresetn] [get_bd_pins SWs_4Bits/s_axi_aresetn] [get_bd_pins axi_dispctrl_0/s_axi_aresetn] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins capture_video_0/s_axi_aresetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net rst_processing_system7_0_97M_peripheral_aresetn [get_bd_pins axi_dispctrl_0/s_axis_mm2s_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins processing_system7_0/FCLK_RESET1_N]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs capture_video_0/S_AXI/S_AXI_reg] -force
